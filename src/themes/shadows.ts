...
const createCustomShadow = (color: string) => {
  ...
  return {
    ...
    card: `0 0 2px 0 ${alpha(color, 0.2)}, 0px 4px 12px 8px ${alpha(color, 0.12)}`,
    cardHover: `0 0 2px 0 ${alpha(color, 0.2)}, 0px 4px 12px 8px ${alpha(color, 0.12)}`,
    dialog: `-40px 40px 80px -8px ${alpha(palette.light.common.black, 0.35)}`,
