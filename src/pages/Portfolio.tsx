...
import { CalendarMenu, LineChart, NewsMenu, PartComponent, PieChart } from '../components';
  ...
  return (
    <Stack padding={2}>
      <PartComponent padding="0" backgroundImage="linear-gradient(to top, rgba(14, 29, 36, 1), rgba(14, 29, 36, 1))">
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ padding: '22px 26px 0 26px' }}>
          <Stack>
            ...
            <Grid item md={12} sm={12} xl={6}>
              <PartComponent backgroundImage="linear-gradient(to top, rgba(14, 29, 36, 1), rgba(22, 44, 54, 1))">
                ...
                <Stack position="relative">
                  ...
                  <Stack
                    position="absolute"
                    sx={{ right: windowWidth > 1535 || windowWidth <= 1024 ? 0 : '200px', top: '58px' }}
                  >
                    {pieData.map((item) => (
                      <Typography
                        variant="caption"
            ...
            <TableBody>
              {PORTFOLIO.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <StyledTableCell
                    align="center"
                    sx={{ color: item.change_1 < 0 ? themeGlobal.palette.error.main : themeGlobal.palette.info.main }}
                  >
